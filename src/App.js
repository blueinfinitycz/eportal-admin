...
const Authenticate = (isLogged) => {
  // console.log("LOG: ", isLogged.isLogged === 0 && document.cookie.length === 0)
...
const App = () => {
  ...
  return(
    <Container className={styles.appContainer} maxWidth="xl">
      ...
      <Grid ref={gridContainer} className={styles.appGrid} container spacing={4} direction="row" justify="center" alignItems= {isLogged === 0 && document.cookie.length === 0 ? 'center': 'top'}>
